...
void Controlador::run(char* dados[]){
    if( m_qntParametro > 2 ){
        ...
        if( m_forma.compare( "triangulo" ) == 0 ){
            ...
            if( m_qntParametro == 4 ){
                Triangulo* t = new Triangulo( std::atoi( dados[2] ), std::atoi( dados[3] ) );
                cout << *t;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 3 ){
                Retangulo* q = new Retangulo( std::atoi( dados[2] ) );
                cout << *q;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 4 ){
                Retangulo* r = new Retangulo( std::atoi( dados[2] ), std::atoi( dados[3] ) );
                cout << *r;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 3 ){
                Circulo* c = new Circulo( std::atoi( dados[2] ) );
                cout << *c;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 3 ){
                Cubo* c = new Cubo( new Retangulo( std::atoi( dados[2] ) ) );
                cout << *c;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 4 ){
                Piramide* p = new Piramide( new Retangulo( std::atoi( dados[2] ) ),
            ...
            if( m_qntParametro == 5 ){
                Paralelepipedo* p = new Paralelepipedo( std::atoi( dados[2] ), std::atoi( dados[3] ), std::atoi( dados[4] ) );
                cout << *p;
            }else{
                erroParam();
            }
            ...
            if( m_qntParametro == 3 ){
                Esfera* e = new Esfera( std::atoi( dados[2] ) );
                cout << *e;
            }else{
                erroParam();
            }
